...
function [] = logProc(subjStr)
    ...
    strippedSubjStr = strsplit(subjStr,'_');
    strippedSubjStr = strippedSubjStr{1};
    readLogPath = ['\\files.rcbi.rochester.edu\foxeAnalysis\MOBI\MOBI_GNG\Data',subjGroup,'\',strippedSubjStr,'\PresentationLogs\'];
    writeLogPath = ['\\files.rcbi.rochester.edu\foxeAnalysis\MOBI\MOBI_GNG\EEGAnalysis\ProcessedLogs\',subjGroup,'\',strippedSubjStr,'\'];
    picsPath = '\\files.rcbi.rochester.edu\foxeAnalysis\MOBI\MOBI_GNG\PresentationCode\';
